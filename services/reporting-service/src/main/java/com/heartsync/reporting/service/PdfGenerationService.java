...
public class PdfGenerationService {
    ...
    /**
     * Generates the HeartSync AI Integrated Clinical Report PDF.
    ...
    private void addHeader(Document doc, ReportData data) throws DocumentException {
        ...
        title.add(new Chunk("HeartSync AI", new Font(Font.HELVETICA, 14, Font.BOLD, TEAL)));
    ...
    private void addFusionInsight(Document doc, ReportData data) throws DocumentException {
        ...
        cell.addElement(new Paragraph("Multimodal Fusion Insight (HeartSync AI Engine)", HEADER_FONT));
    ...
    private void addFooter(Document doc, ReportData data) throws DocumentException {
        String generated = "Generated by: HeartSync AI  |  Report Date: " +
